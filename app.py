...
div[data-testid="stVerticalBlockBorderWrapper"] {
    background: rgba(255, 255, 255, 0.15) !important; /* Tingkat keputihan diturunkan dari 0.4 ke 0.15 (sangat bening) */
    backdrop-filter: blur(8px) !important; /* Efek blur dikurangi agar lebih natural */
    -webkit-backdrop-filter: blur(8px) !important;
    border-radius: 25px !important; 
    border: 1px solid rgba(255, 255, 255, 0.3) !important; /* Garis tepi dibuat lebih transparan/samar */
    padding: 30px !important;
    box-shadow: 0 8px 32px 0 rgba(0, 69, 129, 0.05) !important; /* Bayangan dibuat sangat tipis */
}
